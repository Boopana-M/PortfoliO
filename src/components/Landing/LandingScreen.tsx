...
export const LandingScreen: React.FC<LandingScreenProps> = ({
  ...
  return (
    ...
    >
      {/* 1. Full-Screen High-Resolution Background Cover (100vw x 100vh, object-fit: cover, center center) */}
      ...
      {/* 4. Responsive "OPEN PORTFOLIO" CTA Controls positioned cleanly above background */}
